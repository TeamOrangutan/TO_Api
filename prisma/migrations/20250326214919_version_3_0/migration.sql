/*
  ...
  - You are about to drop the column `subTotal` on the `FAC_PRODUCTO` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "FAC_PRODUCTO" DROP COLUMN "subTotal";
